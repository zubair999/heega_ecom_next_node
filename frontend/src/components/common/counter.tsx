...
const Counter: React.FC<CounterProps> = ({
	...
	return (
		<div
			className={cn(
				"group flex items-center justify-between  overflow-hidden flex-shrink-0",
				{
					"border h-11 md:h-6 border-gray-300": variant === "default",
		...
		>
			<button
				...
				className={cn(
					...
					{
						"w-10 md:w-6 text-heading border-e border-gray-300 hover:text-white hover:bg-heading":
							variant === "default",
			...
			<span
				className={cn(
					...
					{
						"text-base text-heading w-12  md:w-10 xl:w-10":
							variant === "default",
			...
			<button
				...
				className={cn(
					...
					{
						"w-10 md:w-6 text-heading border-s border-gray-300 hover:text-white hover:bg-heading":
							variant === "default",
						"w-8 md:w-9 text-white bg-heading hover:bg-gray-600 focus:outline-none":
							variant === "dark",
					}
